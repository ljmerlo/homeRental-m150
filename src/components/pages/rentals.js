...
const Content = () => {
    return (
        <div className='contents ui container'>
            ...
            <br />
            <HomeCard name={'Nice villa in Paris'} rooms={'5 Bedrooms, 2 Kitchen, 6 Toilets'} balcony={'Balcony and Pool available'} surroundings={'Eiffeltower reachable in 15'} contact={'timophy.tupas@gmx.fr'} imageLink={'https://palmerablue.com/data/img/img5dc188cf679d3f.jpg'} />
            <br />
        </div>
    );
}
